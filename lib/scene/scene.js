...
scene.start = async (map) => {
  ...
  scene.floorCanvas = floorCanvas;
  scene.floorCtx = floorCanvas.getContext("2d");

  scene.entityCanvas = entityCanvas;
  scene.entityCtx = entityCanvas.getContext("2d");

  scene.effectsCanvasMiddle = effectsCanvasMiddle;
  scene.effectsMiddleCtx = effectsCanvasMiddle.getContext("2d");

  scene.effectsCanvasTop = effectsCanvasTop;
  scene.effectsTopCtx = effectsCanvasTop.getContext("2d");
